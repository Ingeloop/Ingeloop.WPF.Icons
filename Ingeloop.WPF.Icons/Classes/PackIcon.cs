...
namespace Ingeloop.WPF.Icons
{
    public class PackIcon : Control
    {
        ...
        public static readonly DependencyProperty IconSizeProperty
            = DependencyProperty.Register(nameof(Size), typeof(double), typeof(PackIcon), new PropertyMetadata((double)24, KindPropertyChangedCallback));
